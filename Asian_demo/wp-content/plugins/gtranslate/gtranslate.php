...
function RefreshDoWidgetCode() {
    ...
    if(translation_method == 'on_fly' || translation_method == 'redirect' || translation_method == 'onfly') {
        ...
        if(widget_look == 'popup') {
            ...
            widget_preview += '.gt_black_overlay {display:none;position:fixed;top:0%;left:0%;width:100%;height:100%;background-color:black;z-index:2017;transition:all 0.3s ease-in-out;-moz-opacity:0.8;opacity:.80;filter:alpha(opacity=80);}'+new_line;
